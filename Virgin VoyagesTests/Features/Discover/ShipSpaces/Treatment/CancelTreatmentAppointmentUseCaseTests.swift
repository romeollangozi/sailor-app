//
//  CancelTreatmentAppointmentUseCaseTests.swift
//  Virgin Voyages
//
...
final class CancelTreatmentAppointmentUseCaseTests: XCTestCase {
    var useCase: CancelTreatmentAppointmentUseCase!
    ...
    override func setUp() {
        ...
        useCase = CancelTreatmentAppointmentUseCase(
