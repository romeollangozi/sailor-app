//
//  GuestNotFoundViewModel.swift
//  Virgin Voyages
//
//  Created by Darko Trpevski on 13.8.25.
//
...
@Observable final class GuestNotFoundViewModel: BaseViewModel, ExceptionViewModelProtocol {

	// MARK: - Properties
	var exceptionTitle: String = "Guest Not Found"
