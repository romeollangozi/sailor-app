...
struct OfflineModeLineUpHeader: View {
		...
		VStack(spacing: Spacing.space0) {
			...
			ZStack {
				...
				VStack(spacing: 8) {
					...
					// Title
					Text("Today’s Event Line-up")
						.font(.vvHeading3Bold)
						.foregroundColor(Color.charcoalBlack)

					// Description text
					Text("For your eyes only – wait until you are back on the ship to make any new bookings.")
						.font(.vvBody)
